...
- [UniprotR](https://cran.r-project.org/web/packages/UniprotR/index.html) for retrieving information on proteins from Uniprot
- [chemspiderapi](https://github.com/RaoulWolf/chemspiderapi) provides a more bare-bones but comprehensive interface to the ChemSpider API
- [rcdk](https://cran.r-project.org/web/packages/rcdk/index.html) allows the user to access functionality in the 'CDK', a Java framework for chemoinformatics.
