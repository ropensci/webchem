structure(list(url = "http://www.ebi.ac.uk:80/webservices/chebi/2.0/webservice", 
    status_code = 200L, headers = structure(list(server = "Apache-Coyote/1.1", 
        ...
        date = "Wed, 02 Aug 2023 21:00:04 GMT"), class = c("insensitive", 
    ...
    date = structure(1691010004, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 2.6e-05, 
    connect = 0, pretransfer = 0.000117, starttransfer = 0.330149, 
    total = 0.33019)), class = "response")
