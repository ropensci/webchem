structure(list(url = "http://www.ebi.ac.uk:80/webservices/chebi/2.0/webservice", 
    status_code = 200L, headers = structure(list(server = "Apache-Coyote/1.1", 
        ...
        date = "Thu, 03 Aug 2023 17:12:09 GMT"), class = c("insensitive", 
    ...
    date = structure(1691082729, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 3e-05, 
    connect = 0, pretransfer = 0.000135, starttransfer = 0.210799, 
    total = 0.210823)), class = "response")
