structure(list(url = "http://www.ebi.ac.uk:80/webservices/chebi/2.0/webservice", 
    status_code = 200L, headers = structure(list(server = "Apache-Coyote/1.1", 
        ...
        date = "Mon, 14 Aug 2023 13:00:42 GMT"), class = c("insensitive", 
    ...
    date = structure(1692018042, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 2.5e-05, 
    connect = 0, pretransfer = 0.000151, starttransfer = 0.216407, 
    total = 0.216991)), class = "response")
